 ...
 */
public class SelfViewDragHelper {
    ...
    private final SelfViewDragHelper.Callback mCallback;
     ...
     */
    public static SelfViewDragHelper create(@NonNull ViewGroup forParent, @NonNull SelfViewDragHelper.Callback cb) {
        return new SelfViewDragHelper(forParent.getContext(), forParent, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static SelfViewDragHelper create(@NonNull ViewGroup forParent, float sensitivity,
                                                                   @NonNull SelfViewDragHelper.Callback cb) {
        final SelfViewDragHelper helper = create(forParent, cb);
     ...
     * @param forParent Parent view to monitor
     */
    private SelfViewDragHelper(@NonNull Context context, @NonNull ViewGroup forParent,
                           @NonNull SelfViewDragHelper.Callback cb) {
        if (forParent == null) {
